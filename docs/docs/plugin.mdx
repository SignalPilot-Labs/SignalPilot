...
The plugin is **Claude Code-specific**. Skills and the verifier agent don't run in Cursor, Codex, or other clients. The 54 MCP tools work everywhere, but skill orchestration is Claude Code-only.
