...
The plugin ships **24 skills** and **2 verifier agents**.

## The 24 skills, by group
...
See [Skills reference](/docs/plugin/skills-reference) for the per-skill load triggers and coverage of all 24 skills.
