---
sidebar_position: 6
sidebar_label: Files and charts
title: Files and charts in chat
hide_title: true
---

import PageHero from '@site/src/components/PageHero';
import { Chat } from '@site/src/components/illustrations';

<PageHero
  eyebrow="Product · Files and charts"
  title="Files and charts in chat"
  lede="Every chart, table, or report the chat agent saves appears next to the conversation as soon as it is written. There is no publish step."
  illustration={<Chat />}
/>
