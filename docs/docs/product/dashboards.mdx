...
<PageHero
  eyebrow="Product · Dashboards"
  title="Published dashboards"
  lede="A chat can save an answer as a dashboard. Publish turns that dashboard into one your team can open on its own, outside the conversation, and refresh on a schedule."
