...
SignalPilot's 62 MCP tools work in any orchestration — not just the bundled skills. This guide shows how to build your own workflows.
...
The tools are the same regardless of which client calls them. Only the skill orchestration is Claude Code-specific.
