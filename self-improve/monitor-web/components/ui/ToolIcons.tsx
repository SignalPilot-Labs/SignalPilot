...
export function getToolIcon(category: ToolCategory, color?: string) {
  switch (category) {
    case "bash":
      return <BashIcon color={color} />;
    case "read":
      return <ReadIcon color={color} />;
    case "write":
      return <WriteIcon color={color} />;
    case "edit":
      return <EditIcon color={color} />;
    case "glob":
      return <GlobIcon color={color} />;
    case "grep":
      return <GrepIcon color={color} />;
    case "agent":
      return <AgentIcon color={color} />;
    case "web_search":
      return <WebSearchIcon color={color} />;
    case "web_fetch":
      return <WebFetchIcon color={color} />;
    case "todo":
      return <TodoIcon color={color} />;
    case "tool_search":
      return <ToolSearchIcon color={color} />;
    case "skill":
      return <SkillIcon color={color} />;
    case "playwright_navigate":
      return <PlaywrightNavigateIcon color={color} />;
    case "playwright_screenshot":
      return <PlaywrightScreenshotIcon color={color} />;
    case "playwright_snapshot":
      return <PlaywrightSnapshotIcon color={color} />;
    case "playwright_click":
      return <PlaywrightClickIcon color={color} />;
    case "playwright_form":
    case "playwright_type":
      return <PlaywrightFormIcon color={color} />;
    case "playwright_evaluate":
      return <PlaywrightEvaluateIcon color={color} />;
    case "session_gate":
      return <SessionGateIcon color={color} />;
    default:
      return <DefaultToolIcon color={color} />;
  }
}
...
export function getAuditIcon(eventType: string, color?: string) {
  switch (eventType) {
    case "round_complete":
      return <RoundCompleteIcon color={color} />;
    case "run_started":
      return <RunStartedIcon color={color} />;
    case "pr_created":
      return <PRCreatedIcon color={color} />;
    case "pr_failed":
      return <ErrorIcon color={color} />;
    case "fatal_error":
      return <ErrorIcon color={color} />;
    case "killed":
      return <KilledIcon color={color} />;
    case "session_ended":
      return <SessionEndedIcon color={color} />;
    case "agent_stop":
      return <StopRequestIcon color={color} />;
    case "ceo_continuation":
      return <CEOIcon color={color} />;
    case "worker_assignment":
      return <WorkerAssignmentIcon color={color} />;
    case "rate_limit":
    case "rate_limit_paused":
      return <RateLimitIcon color={color} />;
    case "sdk_config":
      return <ConfigIcon color={color} />;
