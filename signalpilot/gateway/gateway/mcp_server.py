...
_MAX_CODE_LENGTH = 1_000_000  # kept for potential future use
...
# dbt imports removed — local-only tools (dbt_project_map, fix_date_spine_hazards,
# fix_nondeterminism_hazards, etc.) were removed since the gateway runs in Docker
# and cannot access user filesystems. These features are now provided as standalone
# scripts in the signalpilot-plugin repo.
