...
from signalpilot._config.config import ExportType, SqlOutputType, WidthType
...
class _AppConfig:
    ...
    # sp._ast.parse since these values are read statically.
...
def overloads_from_env() -> _AppConfig:
    ...
    prefix = "_SIGNALPILOT_APP_OVERLOAD_"
