...
from signalpilot._ast.compiler import (
    cell_factory,
    context_cell_factory,
    ir_cell_factory,
    toplevel_cell_factory,
)
from signalpilot._ast.models import CellData
from signalpilot._ast.names import DEFAULT_CELL_NAME, SETUP_CELL_NAME
from signalpilot._ast.parse import fixed_dedent
from signalpilot._ast.pytest import process_for_pytest
from signalpilot._messaging.notebook.changes import CreateCell, Transaction
...
class CellManager:
    """A manager for cells in a sp notebook.
    ...
    def cell_decorator(
        ...
        *,
        ...
        """Create a cell decorator for sp notebook cells."""
        # NB. sp also statically loads notebooks via the sp/_ast/load
