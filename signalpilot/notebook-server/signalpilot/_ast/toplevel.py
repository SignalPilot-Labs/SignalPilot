...
from signalpilot._ast.names import (
    DEFAULT_CELL_NAME,
    SETUP_CELL_NAME,
...
from signalpilot._runtime.dataflow import topological_sort
...
class TopLevelExtraction:
        ...
        def resolve(name: Name) -> bool:
            ...
            if name not in self.unresolved:
                if name in visited:
                    ...
                    return False
                # We are in a cycle. It's safe to serialize, but sp will
    ...
    def from_app(cls, app: InternalApp) -> TopLevelExtraction:
        ...
        from signalpilot._ast.codegen import pop_setup_cell
