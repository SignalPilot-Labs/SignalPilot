...
from signalpilot._ast.sql_visitor import (
    SQLDefs,
    SQLKind,
    SQLRef,
    find_sql_defs,
...
from signalpilot._sql.error_utils import log_sql_error
from signalpilot._utils.strings import standardize_annotation_quotes
...
class ScopedVisitor(ast.NodeVisitor):
    ...
    def deleted_refs(self) -> set[Name]:
        ...
        #     del x
        #
        # In this code, `x` is technically an (unbound) local. But sp treats
    ...
    def visit_Call(self, node: ast.Call) -> ast.Call:
        ...
        # 'mo'/'sp' actually refer to the sp library, but it gets
        # the job done.
        valid_sql_calls = [
            "sp.sql",
            "sp.sql",
    ...
    #
    # Top-level match statements are awkward in sp --- at parse-time,
    ...
    # sp, match statements should really only be used in local scopes.
