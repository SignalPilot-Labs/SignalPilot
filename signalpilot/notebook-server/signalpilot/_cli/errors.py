...
from signalpilot._cli.install_hints import get_install_commands
from signalpilot._cli.print import bold, green, muted, red


class SpCLIError(click.ClickException):
    """Base class for sp CLI errors."""
...
class SpCLIRuntimeError(SpCLIError):
    """Raised for runtime or environment setup failures."""


class SpCLIMissingDependencyError(SpCLIError):
