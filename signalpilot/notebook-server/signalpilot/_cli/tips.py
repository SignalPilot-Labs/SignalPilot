...
CLI_STARTUP_TIPS: Final[tuple[CliTip, ...]] = (
    CliTip(
        ...
        command="sp run notebook.py",
    ),
    CliTip(
        text="Reload the editor when the notebook file is edited externally",
        command="sp edit notebook.py --watch",
    ),
    CliTip(
        text="Run a notebook in an isolated virtual environment",
        command="sp edit --sandbox notebook.py",
    ),
    CliTip(
        text="Open the intro tutorial",
        command="sp tutorial intro",
    ),
    CliTip(
        text="Convert a Jupyter notebook to a sp notebook",
        command="sp convert notebook.ipynb -o notebook.py",
    ),
    CliTip(
        text="Install shell completions",
        command="sp shell-completion",
    ),
    CliTip(
        text="Lint and format notebooks",
        command="sp check --fix .",
    ),
    CliTip(
        text="Generate thumbnails for a folder",
        command="sp export thumbnail folder/",
    ),
    CliTip(
        text="Pair-program with AI agents on running notebooks",
        link="https://docs.signalpilot.ai/docs/",
    ),
    CliTip(
