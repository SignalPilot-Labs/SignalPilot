...
from signalpilot._ast.cell import (
    CellConfig,
    CellImpl,
    RunResultStatusType,
    RuntimeStateType,
)
from signalpilot._ast.cell_id import CellIdGenerator
from signalpilot._ast.compiler import compile_cell
from signalpilot._ast.names import SETUP_CELL_NAME
from signalpilot._code_mode._better_inspect import _HelpableEnumMeta, helpable
from signalpilot._code_mode._packages import (
    Packages,
    _AddPackage,
    _RemovePackage,
)
from signalpilot._code_mode._plan import (
    _AddOp,
    _build_plan,
    _DeleteOp,
    _MoveOp,
...
from signalpilot._runtime.context import get_context as _get_runtime_context
from signalpilot._runtime.context.kernel_context import KernelRuntimeContext
from signalpilot._runtime.runtime import CellMetadata
from signalpilot._types.ids import CellId_t, UIElementId
from signalpilot._utils.formatter import DefaultFormatter
...
if TYPE_CHECKING:
    ...
    from signalpilot._code_mode.screenshot import _ScreenshotSession
    from signalpilot._runtime.dataflow import DirectedGraph
    from signalpilot._runtime.runtime import Kernel
...
class NotebookCell:
    ...
    def status(self) -> CellStatusType | None:
        ...
        - ``"sp-error"`` — prevented from executing (e.g. multiply-defined name).
...
class AsyncCodeModeContext:
    """Async programmatic control of a running sp notebook.
    ...
    def __init__(
        ...
        *,
        ...
        from signalpilot._messaging.notebook.document import get_current_document
    ...
    async def screenshot(
        ...
        *,
        ...
        from signalpilot._code_mode.screenshot import (
            ScreenshotError,
            _ScreenshotSession,
            _to_data_url,
        )
        from signalpilot._messaging.context import HTTP_REQUEST_CTX
    ...
    def _resolve_screenshot_target(
        ...
        from signalpilot._code_mode.screenshot import ScreenshotError
    ...
    def set_ui_value(self, element: Any, value: Any) -> None:
        ...
        Args:
            element: A sp UI element (e.g. ``sp.ui.slider``).
