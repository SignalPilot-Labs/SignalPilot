...
from signalpilot._config.config import SpConfig, PartialSignalPilotConfig
...
def mask_secrets_partial(config: PartialSignalPilotConfig) -> PartialSignalPilotConfig:
    return cast(PartialSignalPilotConfig, mask_secrets(cast(SpConfig, config)))


def mask_secrets(config: SpConfig) -> SpConfig:
