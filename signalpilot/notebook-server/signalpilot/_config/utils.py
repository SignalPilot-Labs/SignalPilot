...
from signalpilot._utils.xdg import sp_config_path

LOGGER = _loggers.sp_logger()

CONFIG_FILENAME = ".sp.toml"
...
def get_or_create_user_config_path() -> str:
    ...
    (i.e. `~/.config/signalpilot` or `$XDG_CONFIG_HOME/signalpilot`)
    """
    try:
...
def get_user_config_path() -> str | None:
    """Find path of config file (.sp.toml).
    ...
    xdg_config_path = sp_config_path()
