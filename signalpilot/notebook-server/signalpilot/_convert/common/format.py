...
from signalpilot._ast.compiler import extract_markdown

if TYPE_CHECKING:
    from signalpilot._ast.cell import Cell, CellImpl

DEFAULT_MARKDOWN_PREFIX = "r"


def markdown_to_signalpilot(
