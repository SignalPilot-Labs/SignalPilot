...
from signalpilot._data.charts import ChartBuilder, get_chart_builder
from signalpilot._data.models import ColumnStats
from signalpilot._data.sql_summaries import (
    get_column_type,
    get_sql_stats,
)
...
from signalpilot._plugins.ui._impl.tables.utils import get_table_manager_or_none
from signalpilot._runtime.commands import PreviewDatasetColumnCommand
from signalpilot._sql.utils import wrapped_sql
from signalpilot._utils.narwhals_utils import downgrade_narwhals_df_to_v1
...
def _get_chart_spec(
    *,
    ...
    with alt.data_transformers.enable("sp_inline_csv"):
        return chart_builder.altair_json(
            column_data,
            column_name,
        )
