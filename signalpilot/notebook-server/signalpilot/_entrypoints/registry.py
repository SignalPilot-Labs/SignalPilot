...
from signalpilot._entrypoints.ids import KnownEntryPoint
...
class EntryPointRegistry(Generic[T]):
    ...
    - SP_{GROUP}_ALLOWLIST: Comma-separated list of allowed extensions
    - SP_{GROUP}_DENYLIST: Comma-separated list of denied extensions

    Example:
        SP_CELL_EXECUTOR_ALLOWLIST=my-executor,another-executor
        SP_CELL_EXECUTOR_DENYLIST=denied-executor
    ...
    def __init__(self, entry_point_group: KnownEntryPoint) -> None:
        ...
        # Convert entry point group to env var format (e.g. sp.cell.executor -> SP_CELL_EXECUTOR)
