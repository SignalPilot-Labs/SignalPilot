...
from signalpilot._schemas.serialization import CellDef, NotebookSerialization
...
class LintContext:
    ...
    def get_graph(self) -> DirectedGraph:
        ...
        with self._graph_lock:
            ...
            from signalpilot._ast.compiler import ir_cell_factory
            from signalpilot._schemas.serialization import UnparsableCell
