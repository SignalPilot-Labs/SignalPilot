...
from signalpilot._lint.context import LintContext, RuleContext
from signalpilot._lint.diagnostic import Severity
...
if TYPE_CHECKING:
    ...
    from signalpilot._lint.diagnostic import Diagnostic
...
class RuleEngine:
    ...
    def create_default(
        ...
        if lint_config is not None:
            from signalpilot._lint.rule_selector import resolve_rules
