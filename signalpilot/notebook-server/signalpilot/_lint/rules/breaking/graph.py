...
from signalpilot._lint.validate_graph import (
    check_for_cycles,
    check_for_invalid_root,
    check_for_multiple_definitions,
)
from signalpilot._lint.visitors import VariableLineVisitor
from signalpilot._types.ids import CellId_t
from signalpilot._utils.cell_matching import match_cell_ids_by_similarity
...
class GraphRule(LintRule):
    ...
    and setup cell violations. These rules ensure sp's core constraints are
    ...
    definitions and references. sp uses this graph to determine execution order
    and enforce constraints that make notebooks reliable and shareable.

    See Also:
        - https://docs.signalpilot.ai/docs/ (Understanding errors)
        - https://docs.signalpilot.ai/docs/ (Dataflow)
    """
...
class MultipleDefinitionsRule(GraphRule):
    ...
    sp requires that each variable be defined in only one cell. This constraint
    ...
    When a variable is defined in multiple cells, sp cannot determine which
    ...
    than one cell, which violates sp's fundamental constraint for reactive execution.

    ## Why is this bad?

    Multiple definitions prevent sp from:
    ...
    **Solution:**
    ...
    - [Multiple Definitions Guide](https://docs.signalpilot.ai/docs/)
...
class CycleDependenciesRule(GraphRule):
    ...
    sp prevents circular dependencies between cells to ensure a well-defined
    ...
    Cycles make notebooks non-reproducible and prevent sp from determining
    ...
    Circular dependencies prevent sp from:
    ...
    **Solution:**
    ...
    - [Cycles Guide](https://docs.signalpilot.ai/docs/)
    - [Understanding Errors](https://docs.signalpilot.ai/docs/)
    """
...
class SetupCellDependenciesRule(GraphRule):
    ...
    The setup cell in sp is special - it runs first and can define variables
    ...
    cycle and violate sp's execution model.
    ...
    Setup cell dependencies break sp's execution model because:
    ...
    **Solution:**
    ...
    - [Setup References Guide](https://docs.signalpilot.ai/docs/)
    - [Understanding Errors](https://docs.signalpilot.ai/docs/)
    """
