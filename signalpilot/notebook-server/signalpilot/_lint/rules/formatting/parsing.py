...
class StdoutRule(LintRule):
    ...
    This rule processes any output that was captured from stdout while sp
...
class StderrRule(LintRule):
    ...
    This rule processes any output that was captured from stderr while sp
...
class SqlParseRule(LintRule):
    ...
    This rule processes log messages captured when sp encounters errors
    ...
    **Triggered by:**
    ...
    - [Understanding Errors](https://docs.signalpilot.ai/docs/)
    - [SQL Support](https://docs.signalpilot.ai/docs/)
    """
