...
from signalpilot._utils.log_formatter import LogFormatter

if TYPE_CHECKING:
    from collections.abc import Generator, Iterator
    from pathlib import Path

# This file manages and creates loggers used throughout sp.
#
...
def sp_logger() -> logging.Logger:
    """Get a logger for sp."""
    logger = get_logger("sp")
...
def get_log_directory() -> Path:
    from signalpilot._utils.xdg import sp_log_dir
...
def make_log_directory() -> None:
    try:
        ...
        sp_logger().debug(f"Failed to create log directory: {e}")
