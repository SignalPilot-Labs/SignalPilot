...
def setup_mcp_server(
    ...
    """
    if mode == "tools":
        from signalpilot._mcp.server.lifespan import mcp_server_lifespan
        from signalpilot._mcp.server.main import (
            setup_mcp_server as _setup_tools,
        )

        _setup_tools(app, allow_remote=allow_remote)
        return mcp_server_lifespan
    elif mode == "code-mode":
        from signalpilot._mcp.code_server.lifespan import (
            code_mcp_server_lifespan,
        )
        from signalpilot._mcp.code_server.main import (
