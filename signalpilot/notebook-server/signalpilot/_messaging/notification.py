...
from signalpilot._data._external_storage.models import (
    StorageEntry,
    StorageNamespace,
)
...
from signalpilot._messaging.context import RUN_ID_CTX, RunId_t
...
from signalpilot._runtime.layout.layout import LayoutConfig
from signalpilot._secrets.models import SecretKeysWithProvider
from signalpilot._sql.parse import SqlCatalogCheckResult, SqlParseResult
...
from signalpilot._utils.msgspec_basestruct import BaseStruct
...
class KernelCapabilitiesNotification(msgspec.Struct):
    ...
    Attributes:
        terminal: Terminal access (requires pty on Unix, pywinpty on Windows; unavailable on Pyodide).
    ...
    def __post_init__(self) -> None:
        self.terminal = self._detect_terminal_support()
