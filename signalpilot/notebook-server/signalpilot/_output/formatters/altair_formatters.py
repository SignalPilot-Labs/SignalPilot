...
from signalpilot._messaging.mimetypes import METADATA_KEY, KnownMimeType, MimeBundle
...
from signalpilot._plugins.ui._impl.altair_chart import (
    AltairChartType,
    chart_to_json,
    get_chart_mimetype,
...
def _format_png_mimebundle(
    ...
    return "application/vnd.sp+mimebundle", json.dumps(mimebundle)
