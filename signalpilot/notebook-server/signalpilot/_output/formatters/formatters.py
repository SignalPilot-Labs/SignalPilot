...
from signalpilot._output.formatters.ai_formatters import (
    GoogleAiFormatter,
    OpenAIFormatter,
    TransformersFormatter,
)
from signalpilot._output.formatters.altair_formatters import AltairFormatter
from signalpilot._output.formatters.anywidget_formatters import AnyWidgetFormatter
from signalpilot._output.formatters.arviz_formatters import ArviZFormatter
from signalpilot._output.formatters.bokeh_formatters import BokehFormatter
from signalpilot._output.formatters.cell import CellFormatter
from signalpilot._output.formatters.df_formatters import (
    DataFusionFormatter,
    DuckDBFormatter,
    IbisFormatter,
    PolarsFormatter,
...
from signalpilot._output.formatters.holoviews_formatters import HoloViewsFormatter
from signalpilot._output.formatters.ipython_formatters import IPythonFormatter
from signalpilot._output.formatters.ipywidgets_formatters import IPyWidgetsFormatter
from signalpilot._output.formatters.leafmap_formatters import LeafmapFormatter
from signalpilot._output.formatters.lets_plot_formatters import LetsPlotFormatter
from signalpilot._output.formatters.matplotlib_formatters import MatplotlibFormatter
from signalpilot._output.formatters.pandas_formatters import PandasFormatter
from signalpilot._output.formatters.panel_formatters import PanelFormatter
from signalpilot._output.formatters.plotly_formatters import PlotlyFormatter
from signalpilot._output.formatters.pyecharts_formatters import PyechartsFormatter
from signalpilot._output.formatters.pygwalker_formatters import PygWalkerFormatter
from signalpilot._output.formatters.pytorch_formatters import PyTorchFormatter
from signalpilot._output.formatters.seaborn_formatters import SeabornFormatter
from signalpilot._output.formatters.structures import StructuresFormatter
from signalpilot._output.formatters.sympy_formatters import SympyFormatter
from signalpilot._output.formatters.tqdm_formatters import TqdmFormatter
from signalpilot._utils.site_packages import is_local_module
...
def register_formatters(theme: Theme = "light") -> None:
    """Register formatters with sp.

    sp comes packaged with rich formatters for a number of third-party
    ...
    library is imported into a sp notebook.
