...
class MatplotlibFormatter(FormatterFactory):
    ...
    def register(self) -> None:
        ...
        from signalpilot._output import mpl  # noqa: F401

        if running_in_notebook():
            matplotlib.use("module://signalpilot._output.mpl")
        ...
        def mime_data_artist(artist: Artist) -> tuple[KnownMimeType, str]:
            from signalpilot._output.mpl import _render_figure_mimebundle
