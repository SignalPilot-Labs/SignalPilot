...
from signalpilot._messaging.mimetypes import METADATA_KEY, KnownMimeType
...
def _render_figure_mimebundle(
    ...
    Returns:
        ...
        Otherwise, mimetype is 'application/vnd.sp+mimebundle' and data is a JSON string
