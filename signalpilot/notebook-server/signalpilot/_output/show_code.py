...
from signalpilot._plugins.ui._impl.input import code_editor
...
def show_code(
    ...
    Use `sp.show_code` to show the code of the current cell along with
    ...
    In the displayed code, all occurrences of sp.show_code(...) will be
    replaced with ...
