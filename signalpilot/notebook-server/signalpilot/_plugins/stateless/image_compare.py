...
from signalpilot._output.utils import normalize_dimension
...
from signalpilot._plugins.stateless.image import ImageLike, _normalize_image
...
def image_compare(
    ...
    Examples:
        ...
        sp.image_compare(before_image="before.jpg", after_image="after.jpg")
        ```
    ...
    return Html(
        build_stateless_plugin(
            component_name="sp-image-comparison",
            args=args,
        )
    )
