...
from signalpilot._utils.dicts import remove_none_values
...
def mermaid(
    ...
    Args:
        ...
        theme: optional Mermaid theme. See
            ...
            for available themes. If not provided, sp picks
        ...
        theme_variables: optional Mermaid `themeVariables` overrides.
            ...
            If provided with `theme=None`, sp automatically sets
