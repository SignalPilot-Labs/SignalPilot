...
from signalpilot._plugins.core.web_component import JSONType, build_ui_plugin
from signalpilot._plugins.ui._core import ids
...
from signalpilot._types.ids import UIElementId

if TYPE_CHECKING:
    from collections.abc import Callable, Sequence

    from signalpilot._plugins.ui._impl.input import form as form_plugin
...
class SpConvertValueException(Exception):
    pass
...
class UIElement(Html, Generic[S, T]):
    ...
    **Methods.**
    ...
    def _initialize(
        ...
        text = (
            f"<sp-ui-element object-id='{self._id}' "
    ...
    def _repr_markdown_(self) -> str:
        # When rendering to markdown, remove the sp-ui-element tag
