...
from signalpilot._plugins.ui._impl.charts.altair_transformer import (
    register_transformers,
    sanitize_nan_infs,
)
from signalpilot._utils import flatten
...
def _parse_spec(spec: altair.TopLevelMixin) -> VegaSpec:
    ...
    with alt.data_transformers.enable("sp_arrow"):
...
class altair_chart(UIElement[ChartSelection, ChartDataType]):
    ...
    Use `sp.ui.altair_chart` to make Altair charts reactive: select chart data
    ...
    def __init__(
        ...
        *,
        ...
        DependencyManager.altair.require(why="to use `sp.ui.altair_chart`")
        ...
        try:
            ...
            # similarly to the issue described in https://docs.signalpilot.ai/docs/
        ...
        if _using_vegafusion() and (
            ...
            legend_selection = False
            sys.stderr.write(
                "Selection is not yet supported while using vegafusion with sp.ui.altair_chart.\n"
    ...
    def apply_selection(self, df: ChartDataType) -> ChartDataType:
        ...
        Examples:
            ...
            chart = sp.ui.altair_chart(_chart)
            chart
