...
from signalpilot._plugins.ui._impl.comm import (  # pyright: ignore[reportMissingTypeStubs]
    BufferType,
    SpComm,
    SpCommManager,
)
...
# Initialize ipywidgets using a SpComm
def init_signalpilot_widget(w: ipywidgets.Widget) -> None:
    DependencyManager.ipywidgets.require("for anywidget support.")
    import ipywidgets  # type: ignore

    __protocol_version__ = ipywidgets._version.__protocol_version__
    from signalpilot._plugins.ui._impl.anywidget.utils import extract_buffer_paths
...
WIDGET_COMM_MANAGER = SpCommManager()
