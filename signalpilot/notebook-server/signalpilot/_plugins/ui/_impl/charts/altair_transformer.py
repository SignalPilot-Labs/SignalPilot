...
from signalpilot._plugins.ui._impl.tables.utils import (
    get_table_manager,
...
def _to_signalpilot_json(data: Data, **kwargs: Any) -> _TransformResult:
    """
...
def _to_signalpilot_csv(data: Data, **kwargs: Any) -> _TransformResult:
    """
...
def _to_signalpilot_arrow(data: Data, **kwargs: Any) -> _TransformResult:
    """
    ...
    try:
        ...
        return _to_signalpilot_csv(data)
...
def _to_signalpilot_inline_csv(data: Data, **kwargs: Any) -> _TransformResult:
    """
    Custom implementation of altair.utils.data.to_csv that
...
def _data_to_json_string(data: _DataType) -> str:
    ...
    raise NotImplementedError(
        "to_signalpilot_json only works with data expressed as a DataFrame "
...
def register_transformers() -> None:
    ...
    alt.data_transformers.register("sp", _to_signalpilot_csv)  # type: ignore[arg-type]
    alt.data_transformers.register("sp_inline_csv", _to_signalpilot_inline_csv)  # type: ignore[arg-type]
    alt.data_transformers.register("sp_json", _to_signalpilot_json)  # type: ignore[arg-type]
    alt.data_transformers.register("sp_csv", _to_signalpilot_csv)  # type: ignore[arg-type]
    alt.data_transformers.register("sp_arrow", _to_signalpilot_arrow)  # type: ignore[arg-type]
