...
@deprecated(
    "sp.ui.experimental_data_editor is deprecated. Use sp.ui.data_editor instead"
)
...
class data_editor(
    ...
    Examples:
        ...
        editor = sp.ui.data_editor(data=df, label="Edit Data")
        ```
        ...
        editor = sp.ui.data_editor(data=data, label="Edit Data")
        ```
    ...
    _name: Final[str] = "sp-data-editor"
