...
from signalpilot._plugins.ui._impl.table import (
    DownloadAsArgs,
    DownloadAsResponse,
    SearchTableArgs,
    SearchTableResponse,
...
from signalpilot._plugins.ui._impl.tables.format import FormatMapping
...
from signalpilot._utils.narwhals_utils import is_narwhals_lazyframe, make_lazy
from signalpilot._utils.parse_dataclass import parse_raw
from signalpilot._utils.variable_name import infer_variable_name
...
class dataframe(UIElement[dict[str, Any], DataFrameType]):
    ...
    Examples:
        ```python
        dataframe = sp.ui.dataframe(data)
        ```
