...
from signalpilot._plugins.validators import validate_one_of
from signalpilot._runtime.functions import Function
from signalpilot._utils.files import natural_sort
from signalpilot._utils.paths import is_cloudpath, normalize_path
...
class file_browser(
    ...
    Examples:
        ...
        file_browser = sp.ui.file_browser(initial_path=cloudpath)
        ```
    ...
    _name: Final[str] = "sp-file-browser"
