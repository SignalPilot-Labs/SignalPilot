...
def get_anywidget_state(widget: AnyWidget) -> AnyWidgetState:
    ...
    # see sp/_smoke_tests/issues/2366-anywidget-binary.py
...
class anywidget(UIElement[ModelIdRef, AnyWidgetState]):
    ...
    integration of AnyWidget instances with SignalPilot's UI system.
    ...
    Examples:
        ...
        scatter = sp.ui.anywidget(scatter)
