...
from signalpilot._plugins.stateless.mpl._mpl import (
    css_content,
    new_figure_manager_given_figure,
    patch_javascript,
    png_bytes,
)
from signalpilot._plugins.ui._core.ui_element import InitializationArgs, UIElement
...
from signalpilot._runtime.context import RuntimeContext
...
class _SyncWebSocket:
    ...
    Translates send_json/send_binary calls into SpComm messages
    ...
    def __init__(self, comm: SpComm) -> None:
        self._comm = comm
...
class mpl_interactive(UIElement[ModelIdRef, dict[str, Any]]):
    ...
    Uses SpComm for bidirectional communication instead of a
    ...
    def __init__(self, figure: Figure | SubFigure) -> None:
        ...
        self._comm = SpComm(
            ...
            target_name="sp.mpl_interactive",
        ...
        super().__init__(
            component_name="sp-mpl-interactive",
...
class _MplCleanupHandle(CellLifecycleItem):
    """Cleans up the matplotlib figure manager and SpComm on cell re-run or deletion."""
