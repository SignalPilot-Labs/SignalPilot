...
class plotly(UIElement[PlotlySelection, list[dict[str, Any]]]):
    ...
    Use `sp.ui.plotly` to make plotly plots reactive: select data with your
    ...
    Examples:
        ...
        plot = sp.ui.plotly(_plot)
        ```

        ```python
        # View the plot and selected data
        sp.hstack([plot, plot.value])
        ```
    ...
    def __init__(
        ...
        *,
        ...
        DependencyManager.plotly.require("for `sp.ui.plotly`")
