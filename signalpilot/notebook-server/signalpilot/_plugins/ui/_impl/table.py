...
import signalpilot._output.data.data as mo_data
from signalpilot import _loggers
from signalpilot._data.models import BinValue, ColumnStats, ValueCount
from signalpilot._data.preview_column import get_column_preview_dataset
...
from signalpilot._messaging.notification import ColumnPreview
from signalpilot._output.hypertext import is_non_interactive
from signalpilot._output.mime import MIME
...
from signalpilot._plugins.ui._impl.charts.altair_transformer import _to_signalpilot_arrow
from signalpilot._plugins.ui._impl.dataframes.transforms.apply import (
    apply_transforms_to_df,
)
from signalpilot._plugins.ui._impl.dataframes.transforms.types import (
    FilterCondition,
    FilterGroup,
    FilterRowsTransform,
    TransformType,
...
from signalpilot._plugins.ui._impl.tables.selection import (
    INDEX_COLUMN_NAME,
    add_selection_column,
)
from signalpilot._plugins.ui._impl.tables.table_manager import (
    ColumnName,
    FieldTypes,
    RowId,
    TableCell,
...
from signalpilot._plugins.ui._impl.tables.utils import get_table_manager
from signalpilot._plugins.ui._impl.utils.dataframe import (
    ListOrTuple,
    TableData,
    download_as,
    get_bound_name,
...
from signalpilot._runtime.functions import EmptyArgs, Function
from signalpilot._utils.hashable import is_hashable
from signalpilot._utils.memoize import memoize_last_value
from signalpilot._utils.methods import getcallable
from signalpilot._utils.narwhals_utils import (
...
def get_default_table_page_size() -> int:
    ...
    try:
        ...
        return ctx.signalpilot_config["display"]["default_table_page_size"]
...
def get_default_table_max_columns() -> int:
    ...
    try:
        ...
        return ctx.signalpilot_config["display"]["default_table_max_columns"]
...
class table(
    ...
    Args:
        data (Union[List[Union[str, int, float, bool, MIME, None]], List[Dict[str, JSONType]], Dict[str, List[JSONType]], IntoDataFrame]):
            Values can be primitives (`str`, `int`, `float`, `bool`, or `None`) or sp elements:
            e.g. `sp.ui.button(...)`, `sp.md(...)`, `sp.as_html(...)`, etc. Data can be passed in many ways:
    ...
    def _get_data_url(self, args: EmptyArgs) -> GetDataUrlResponse:
        ...
        if DependencyManager.altair.has():
            result = _to_signalpilot_arrow(self._searched_manager.data)
    ...
    def _get_page_row_ids(
        ...
        this reads actual ``_signalpilot_row_id`` values from the searched
    ...
    def _search(self, args: SearchTableArgs) -> SearchTableResponse:
        ...
        def clamp_rows_and_columns(
            ...
            if max_columns is not None and len(column_names) > max_columns:
                ...
                # Always include _signalpilot_row_id so the frontend can use
