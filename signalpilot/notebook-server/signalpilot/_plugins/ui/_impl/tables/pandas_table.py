...
from signalpilot._data.models import ExternalDataType
from signalpilot._dependencies.dependencies import DependencyManager
from signalpilot._output.data.data import sanitize_json_bigint
from signalpilot._plugins.ui._impl.tables.format import (
    FormatMapping,
    format_value,
)
from signalpilot._plugins.ui._impl.tables.narwhals_table import NarwhalsTableManager
from signalpilot._plugins.ui._impl.tables.selection import INDEX_COLUMN_NAME
...
if TYPE_CHECKING:
    ...
    from signalpilot._plugins.ui._impl.table import SortArgs
            ...
            def to_json_str(
                ...
                if isinstance(result.index, pd.MultiIndex) or (
                    ...
                    if unnamed_indexes:
                        ...
                        if index_levels > 1:
                            LOGGER.warning(
                                "Indexes with more than one level are not well supported, call reset_index() or use sp.plain(df)"
                            )
