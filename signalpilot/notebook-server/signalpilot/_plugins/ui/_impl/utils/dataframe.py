...
from signalpilot._output.data import data as mo_data
...
from signalpilot._plugins.ui._impl.tables.table_manager import TableManager
...
def download_as(
    ...
    ext: str,
    drop_signalpilot_index: bool = False,
    ...
    Args:
        ...
        drop_signalpilot_index (bool, optional): Whether to drop the sp selection column.
            Defaults to False.
