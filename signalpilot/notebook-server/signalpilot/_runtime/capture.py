...
from signalpilot._messaging.thread_local_streams import ThreadLocalStreamProxy
from signalpilot._plugins.stateless.plain_text import plain_text
from signalpilot._runtime.output import _output
...
def capture_stdout() -> Iterator[io.StringIO]:
    ...
    Examples:
        ```python
        with sp.capture_stdout() as buffer:
            print("Hello!")
...
def capture_stderr() -> Iterator[io.StringIO]:
    ...
    Examples:
        ```python
        with sp.capture_stderr() as buffer:
