...
if TYPE_CHECKING:
    ...
    from signalpilot._ast.app import (
        AppKernelRunnerRegistry,
        InternalApp,
    )
    from signalpilot._config.config import SpConfig
    from signalpilot._messaging.types import Stderr, Stdout, Stream
    ...
    from signalpilot._runtime.virtual_file import VirtualFileRegistry
...
class ExecutionContext:
    ...
    # outputs set imperatively via sp.output.append and associated functions
