...
def running_in_notebook() -> bool:
    """Returns True if running in a sp notebook, False otherwise"""
...
def get_mode() -> RunMode | None:
    """Returns the current mode of the sp app.

    Returns:
        Optional[Literal["run", "edit", "script", "test"]]: The current mode,
        or None if sp has no context initialized.
    """
    try:
        from signalpilot._runtime.context.kernel_context import KernelRuntimeContext
