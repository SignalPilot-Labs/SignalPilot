...
def _ro_fail() -> None:
    raise ReadOnlyError(
        ...
        " possible by utilizing the sp.unwrap_copy() function."
    )
...
def shadow_wrap(ref_cls: type[_Copy[T]], base: T) -> T:
    ...
    class ReadOnly_try_signalpilot_unwrap_copy(ref_cls):  # type: ignore
    ...
    return cast(T, ReadOnly_try_signalpilot_unwrap_copy())
