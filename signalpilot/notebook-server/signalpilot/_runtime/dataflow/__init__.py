...
from signalpilot._runtime.dataflow.graph import DirectedGraph
from signalpilot._runtime.dataflow.runner import Runner
from signalpilot._runtime.dataflow.topology import GraphTopology
from signalpilot._runtime.dataflow.types import Edge, EdgeWithVar
...
def prune_cells_for_overrides(
    ...
    if missing_defs:
        from signalpilot._ast.errors import IncompleteRefsError
