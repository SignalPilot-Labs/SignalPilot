...
from signalpilot._ast.compiler import code_key
from signalpilot._ast.variables import is_mangled_local
from signalpilot._runtime.dataflow import edges
from signalpilot._runtime.dataflow.cycles import CycleTracker
from signalpilot._runtime.dataflow.definitions import DefinitionRegistry
from signalpilot._runtime.dataflow.topology import (
    GraphTopology,
...
class DirectedGraph(GraphTopology):
    ...
    def disable_cell(self, cell_id: CellId_t) -> None:
        ...
        from signalpilot._runtime.dataflow import transitive_closure
    ...
    def set_stale(
        ...
        from signalpilot._runtime.dataflow import (
