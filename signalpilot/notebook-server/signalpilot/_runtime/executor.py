...
def _raise_name_error(
    ...
    if graph is None:
        raise SpRuntimeException from name_error
    ...
    if missing_name in graph.definitions:
        raise SpRuntimeException from SpMissingRefError(
...
class DefaultExecutor(Executor):
    async def execute_cell_async(
        ...
        try:
            ...
            # to execution
            raise SpRuntimeException from e
                ...
                if (
                    ...
                    try:
                        ...
                        raise CloneError(
                            ...
                            "making an issue on the sp GitHub "
