...
from signalpilot._runtime import patches
...
from signalpilot._runtime.context.types import teardown_context
from signalpilot._runtime.input_override import input_override
from signalpilot._runtime.runner.hooks import (
    NotebookCellHooks,
    Priority,
    create_default_hooks,
)
from signalpilot._runtime.utils.set_ui_element_request_manager import (
...
if TYPE_CHECKING:
    ...
    from signalpilot._messaging.types import Stderr, Stdin, Stdout, Stream
    from signalpilot._runtime import sp_pdb
    from signalpilot._runtime.commands import (
        AppMetadata,
        BatchableCommand,
        CommandMessage,
...
def _build_hooks(
    is_edit_mode: bool, user_config: SpConfig
) -> NotebookCellHooks:
    from signalpilot._runtime.runner.hooks_post_execution import (
        attempt_pytest,
        broadcast_gateway_connections,
    ...
    if is_edit_mode:
        ...
        hooks.add_post_execution(broadcast_gateway_connections, Priority.LATE)
    return hooks
