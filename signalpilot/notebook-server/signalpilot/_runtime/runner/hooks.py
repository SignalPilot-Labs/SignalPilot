...
def create_default_hooks() -> NotebookCellHooks:
    ...
    """
    from signalpilot._runtime.runner.hooks_on_finish import ON_FINISH_HOOKS
    from signalpilot._runtime.runner.hooks_post_execution import (
        POST_EXECUTION_HOOKS,
    )
    from signalpilot._runtime.runner.hooks_pre_execution import (
        PRE_EXECUTION_HOOKS,
    )
    from signalpilot._runtime.runner.hooks_preparation import (
        PREPARATION_HOOKS,
    )
