...
from signalpilot._messaging.types import Stdin, Stdout
...
def try_restart() -> bool:
    from signalpilot._runtime.commands import ExecuteCellsCommand
...
class SpPdb(Pdb):
    ...
    def __init__(
        ...
        # it's fine to use input() since sp overrides it, but disable
