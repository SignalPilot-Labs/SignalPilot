...
from signalpilot._runtime.state import SetFunctor
from signalpilot._save.stubs import (
    CUSTOM_STUBS,
    CustomStub,
    FunctionStub,
    ModuleStub,
...
UNEXPECTED_FAILURE_BOILERPLATE = (
    "— this is"
    " unexpected and is likely a bug in sp. "
...
if TYPE_CHECKING:
    from signalpilot._ast.visitor import Name
...
class CacheState:
    ...
    def is_memoizable(self, value: Any) -> bool:
        ...
        """
        from signalpilot._runtime.primitives import is_data_primitive, is_primitive
...
class Cache:
    ...
    def update(
        ...
        self.meta["version"] = SP_CACHE_VERSION
