...
from signalpilot._save.stores import DEFAULT_STORE, Store
...
INCONSISTENT_CACHE_BOILER_PLATE = (
    ...
    "corruption or an incompatible sp "
    "version. Alternatively, this may be a bug"
    " in sp. Please file an issue at "
...
class Loader(ABC):
    ...
    numpy or pandas dataframes), or remote storage (such as S3 or sp
    cloud).
    """
    ...
    def cache(cls, *args: Any, **kwargs: Any) -> Any:
        """General `sp.cache` api for this loader"""
        from signalpilot._save.save import cache
