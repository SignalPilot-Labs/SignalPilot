...
- **notifications** (from `sp/_messaging/notification.py`): Schema for kernel notifications sent to the client
...
1. Add the new schema to the `sp/_schemas` directory.
2. Run `sp edit scripts/generate_schemas.py` and add the schema (should be analogous to others).
