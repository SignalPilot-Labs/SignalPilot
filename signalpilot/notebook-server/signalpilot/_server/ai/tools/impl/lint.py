...
from signalpilot._lint.rule_engine import RuleEngine
...
class LintNotebook(ToolBase[LintNotebookArgs, LintNotebookOutput]):
    """Lint a sp notebook to check for issues.

    Uses sp's internal linting engine to check for:
    ...
    guidelines = ToolGuidelines(
        when_to_use=[
            "ALWAYS use this tool after making ANY EDITS, CELLS, OR CHANGES to a sp notebook to verify you didn't introduce any issues",
            "ALWAYS use this tool when you want to lint a sp notebook instead of using your own default linting tool",
