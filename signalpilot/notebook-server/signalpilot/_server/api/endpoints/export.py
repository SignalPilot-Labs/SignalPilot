...
from signalpilot._server.export.exporter import AutoExporter, Exporter
...
async def auto_export_as_html(
    *,
    ...
    async def _background_export() -> None:
        ...
        # Save the HTML file to disk, at `.sp/<filename>.html`
...
async def auto_export_as_markdown(
    *,
    ...
    async def _background_export() -> None:
        ...
        # Save the Markdown file to disk, at `.sp/<filename>.md`
...
async def auto_export_as_ipynb(
    *,
    ...
    async def _background_export() -> None:
        ...
        # Save the IPYNB file to disk, at `.sp/<filename>.ipynb`
