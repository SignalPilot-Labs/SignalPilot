...
from signalpilot._runtime.packages.package_manager import PackageManager
...
from signalpilot._server.models.packages import (
    AddPackageRequest,
...
def _get_package_manager(request: Request) -> PackageManager:
    ...
    from signalpilot._session.managers.ipc import IPCKernelManagerImpl
