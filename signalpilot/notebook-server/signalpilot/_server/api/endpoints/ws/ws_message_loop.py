...
from signalpilot._messaging.serde import deserialize_kernel_notification_name
from signalpilot._messaging.types import KernelMessage
from signalpilot._server.api.endpoints.ws.ws_formatter import format_wire_message
...
class WebSocketMessageLoop:
    ...
    async def _listen_for_disconnect(self) -> None:
        ...
        try:
            # Check for sp updates when connection starts
