...
from signalpilot._server.api.auth import TOKEN_QUERY_PARAM, validate_auth
...
from signalpilot._utils.print import print_tabbed
...
class SkewProtectionMiddleware:
    HEADER_NAME: Final[str] = "Sp-Server-Token"
    ...
    async def _proxy_websocket(
        ...
        try:
            ...
            if original_params:
                ...
                # Strip the access_token param — it's only used by sp
