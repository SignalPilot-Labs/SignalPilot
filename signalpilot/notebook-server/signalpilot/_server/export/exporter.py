...
from signalpilot._convert.ipynb.from_ir import (
...
from signalpilot._server.templates.templates import (
...
ROOT = (sp_package_path() / "_static").resolve()
...
class Exporter:
    ...
    def export_as_wasm(
        ...
        *,
        ...
        config: SpConfig = deep_copy(DEFAULT_CONFIG)
        config["display"] = display_config
        # Remove autosave
    ...
    def export_as_pdf(
        ...
        *,
        ...
        if png_fallbacks:
            from signalpilot._server.export._nbformat_png_fallbacks import (
    ...
    def export_public_folder(
        self, directory: Path, signalpilot_file: SpPath
    ) -> bool:
        FOLDER_NAME = "public"
        public_dir = signalpilot_file.path.parent / FOLDER_NAME
