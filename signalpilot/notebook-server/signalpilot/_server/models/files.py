...
from signalpilot._metadata.opengraph import OpenGraphMetadata
from signalpilot._server.models.models import BaseResponse
...
FsEventType = Literal[
    "created", "modified", "deleted", "moved", "snapshot", "resync"
]


class FsEvent(msgspec.Struct, rename="camel"):
    type: FsEventType
    path: str | None = None
