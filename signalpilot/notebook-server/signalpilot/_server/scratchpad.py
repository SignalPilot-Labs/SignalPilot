...
from signalpilot._server.ai.tools.notebook_types import CodeExecutionResult
...
from signalpilot._session.extensions.types import EventAwareExtension
    ...
    def on_notification_sent(
        ...
        if msg.cell_id == SCRATCH_CELL_ID:
            ...
            if (
                ...
                and msg.output.channel == CellChannel.SP_ERROR
...
def build_done_event(
    ...
    if (
        output is not None
        and output.channel == CellChannel.SP_ERROR
