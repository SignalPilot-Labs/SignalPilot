...
from signalpilot._mcp.setup import McpType, setup_mcp_server
from signalpilot._messaging.notification import StartupLogsNotification
from signalpilot._runtime.commands import SerializedCLIArgs
from signalpilot._runtime.parent_poller import start_parent_poller
from signalpilot._server.api import lifespans
from signalpilot._server.config import (
    StarletteServerStateInit,
)
from signalpilot._server.lsp import CompositeLspServer, NoopLspServer
...
from signalpilot._server.utils import (
    initialize_asyncio,
    initialize_fd_limit,
)
from signalpilot._server.uvicorn_utils import initialize_signals
from signalpilot._server.workspace import (
    DirectoryWorkspace,
    NotebookWorkspace,
)
from signalpilot._session.model import SessionMode
from signalpilot._tracer import LOGGER
from signalpilot._utils.lifespans import Lifespans
from signalpilot._utils.net import find_free_port

if TYPE_CHECKING:
    from signalpilot._cli.tips import CliTip
...
def start(
    *,
    ...
    ancestor_pid_env = os.environ.get("SP_ANCESTOR_PID")
    if ancestor_pid_env:
        try:
            start_parent_poller(
            ...
            LOGGER.warning(
                "Ignoring invalid SP_ANCESTOR_PID=%r", ancestor_pid_env
            )
    ...
    if (
        ...
        LOGGER.warning(
            "Using `sp run <folder> --watch`: gallery files are "
