...
from signalpilot._messaging.notebook.changes import TransactionSource
...
from signalpilot._messaging.serde import try_deserialize_kernel_notification_name
...
from signalpilot._utils.distributor import (
    ConnectionDistributor,
    Distributor,
    QueueDistributor,
)
from signalpilot._utils.print import print_, print_tabbed
from signalpilot._utils.serial_task_runner import SerialTaskRunner

if TYPE_CHECKING:
    from logging import Logger

    from signalpilot._session.events import (
        SessionEventBus,
    )
...
class NotificationListenerExtension(SessionExtension):
    ...
    def __init__(
        ...
        self._autosave_runner = SerialTaskRunner(
            thread_name_prefix="sp-autosave"
        )
