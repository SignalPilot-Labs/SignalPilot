...
"""File change handling for sp notebooks.
...
from signalpilot._messaging.notebook.changes import DeleteCell, Transaction
from signalpilot._messaging.notification import (
    NotebookDocumentTransactionNotification,
    ReloadNotification,
)
from signalpilot._runtime.commands import SyncGraphCommand
...
class EditModeReloadStrategy(ReloadStrategy):
    ...
    def __init__(self, config_manager: SpConfigManager) -> None:
...
class FileChangeCoordinator:
    ...
    async def handle_change(
        ...
        to the frontend when a sp file is modified.
...
def create_reload_strategy(
    mode: SessionMode, config_manager: SpConfigManager
) -> ReloadStrategy:
