...
from signalpilot._session.queue import route_control_request
from signalpilot._session.types import QueueManager
...
class QueueManagerImpl(QueueManager):
    ...
    def __init__(self, *, use_multiprocessing: bool):
        context = get_mp_context() if use_multiprocessing else None
