...
from signalpilot._ast import load
from signalpilot._ast.app import App, InternalApp
from signalpilot._ast.app_config import overloads_from_env
...
from signalpilot._runtime.layout.layout import (
    LayoutConfig,
    read_layout_config,
    save_layout_config,
)
from signalpilot._schemas.serialization import Header, NotebookSerializationV1
...
from signalpilot._utils.scripts import with_python_version_requirement
...
if TYPE_CHECKING:
    ...
    from signalpilot._messaging.notebook.document import NotebookCell
...
def canonicalize_filename(filename: str) -> str:
    ...
    if not SpPath.is_valid_path(filename):
        filename += ".py"
...
class AppFileManager:
    ...
    def from_app(
        ...
        Args:
            ...
            filename: Optional source path for the notebook. When set,
                ...
                ``sp.notebook_dir()`` inside cells) resolves to the source
    ...
    def _save_file(
        ...
        *,
        ...
        with self._save_lock:
            ...
            # For new .py files in sandbox mode, generate header with sp
            if header is None and str(path).endswith(".py"):
                ...
                if GLOBAL_SETTINGS.MANAGE_SCRIPT_METADATA:
                    from signalpilot._utils.scripts import (
    ...
    def to_code(self) -> str:
        ...
        return SpConvert.from_ir(self.app.to_ir()).to_py()
