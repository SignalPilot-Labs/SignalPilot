...
def _():
    ...
    print(traces.head())
    return alt, sp, traces


@app.cell
def _(sp):
    sp.md(r"""## Plain Altair""")
    return
...
@app.cell
def _(sp):
    sp.md(r"""## Example of the Or ( | ) operator""")
    return
...
def _(alt, sp, traces):
    ...
    chart_overview = sp.ui.altair_chart(
        alt.Chart(traces, height=150, width=550)
        .mark_line()
        .encode(x="index:Q", y="value:Q", color="traces:N")
        .add_params(_brush),
    ...
    chart_detail = sp.ui.altair_chart(
        alt.Chart(traces)
        .mark_line()
        .encode(x="index:Q", y="value:Q", color="traces:N")
        .transform_filter(_brush),
...
@app.cell
def _(sp):
    sp.md(r"""## Example of the Or ( | ) operator with selection""")
    return
