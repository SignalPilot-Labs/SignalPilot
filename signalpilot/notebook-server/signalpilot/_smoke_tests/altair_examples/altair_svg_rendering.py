...
# ]
# ///
# Repro for https://docs.signalpilot.ai/docs/
# and https://docs.signalpilot.ai/docs/
...
def _(chart_with_images):
    ...
    # When sp detects an SVG with external resources (e.g., image URLs),
