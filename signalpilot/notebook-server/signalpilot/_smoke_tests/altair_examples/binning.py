...
@app.cell(hide_code=True)
def _(sp):
    sp.md(r"""## Basic Histogram with Auto-binning""")
    return
...
def _(alt, sp, movies):
    ...
    basic_histogram = sp.ui.altair_chart(
...
@app.cell
def _(basic_histogram, sp):
    sp.vstack([basic_histogram.value])
    return
...
@app.cell(hide_code=True)
def _(sp):
    sp.md(r"""## Histogram with Custom Bin Parameters""")
    return
...
def _(alt, cars, sp):
    ...
    custom_bins = sp.ui.altair_chart(
        alt.Chart(cars)
        .mark_bar()
        .encode(
            x=alt.X(
...
@app.cell
def _(custom_bins, sp):
    sp.vstack([custom_bins.value])
    return


@app.cell(hide_code=True)
def _(sp):
    sp.md(r"""## Histogram with Fixed Bin Step""")
    return
...
@app.cell
def _(sp, step_bins):
    sp.vstack([step_bins.value])
    return


@app.cell(hide_code=True)
def _(sp):
    sp.md(r"""## 2D Binning (Heatmap)""")
    return
...
@app.cell
def _(heatmap, sp):
    sp.vstack([heatmap.value])
    return


@app.cell(hide_code=True)
def _(sp):
    sp.md(r"""## Binned Color Encoding""")
    return
...
def _(alt, cars, sp):
    ...
    binned_color = sp.ui.altair_chart(
        alt.Chart(cars)
        .mark_circle(size=60)
        .encode(
...
@app.cell
def _(binned_color, sp):
    sp.vstack([binned_color.value])
    return


@app.cell(hide_code=True)
def _(sp):
    sp.md(r"""## Binned Size Encoding""")
    return
...
def _(alt, cars, sp):
    ...
    binned_size = sp.ui.altair_chart(
        alt.Chart(cars)
        .mark_point()
        .encode(
            x=alt.X("Horsepower:Q", title="Horsepower"),
...
@app.cell
def _(binned_size, sp):
    sp.vstack([binned_size.value])
    return


@app.cell(hide_code=True)
def _(sp):
    sp.md(r"""## Stacked Histogram with Binning""")
    return
...
def _(alt, cars, sp):
    ...
    stacked_histogram = sp.ui.altair_chart(
        alt.Chart(cars)
        .mark_bar()
        .encode(
...
@app.cell
def _(sp, stacked_histogram):
    sp.vstack([stacked_histogram.value])
    return


@app.cell(hide_code=True)
def _(sp):
    sp.md(r"""## Binning with Selection""")
    return
...
def _(alt, sp, movies):
    ...
    binned_selection = sp.ui.altair_chart(
        alt.Chart(movies)
        .mark_bar()
        .encode(
            x=alt.X("IMDB_Rating:Q", bin=True, title="IMDB Rating"),
...
@app.cell
def _(binned_selection, sp):
    sp.vstack([binned_selection.value, binned_selection.selections])
    return


@app.cell(hide_code=True)
def _(sp):
    sp.md(r"""## Custom Bin Extent""")
    return
...
def _(alt, cars, sp):
    ...
    extent_bins = sp.ui.altair_chart(
        alt.Chart(cars)
        .mark_bar()
        .encode(
            x=alt.X(
...
@app.cell
def _(extent_bins, sp):
    sp.vstack([extent_bins.value])
    return
