...
def _(sp):
    ...
    Test case for https://docs.signalpilot.ai/docs/
...
@app.cell(hide_code=True)
def _(sp):
    sp.md(r"""### Composite chart with error bars and points""")
    return


@app.cell
def _(alt, sp, sample_df):
    ...
    sample_mo_chart = sp.ui.altair_chart(alt_chart)
...
@app.cell(hide_code=True)
def _(sp):
    sp.md(r"""### Simple layered chart (for comparison)""")
    return
...
def _(alt, sp, pd):
    ...
    simple_mo_chart = sp.ui.altair_chart(simple_chart)
    simple_mo_chart
...
@app.cell(hide_code=True)
def _(sp):
    sp.md(r"""### Workaround with explicit legend selection""")
    return
...
def _(alt, sp, sample_df):
    ...
    workaround_mo_chart = sp.ui.altair_chart(
...
@app.cell(hide_code=True)
def _(sp):
    sp.md(r"""### vconcat with legend selection""")
    return
...
def _(alt, sp, pd):
    ...
    vconcat_mo_chart = sp.ui.altair_chart(vconcat_chart)
    vconcat_mo_chart
...
@app.cell(hide_code=True)
def _(sp):
    sp.md(r"""### hconcat with legend selection""")
    return
...
def _(alt, sp, pd):
    ...
    hconcat_mo_chart = sp.ui.altair_chart(hconcat_chart)
    hconcat_mo_chart
