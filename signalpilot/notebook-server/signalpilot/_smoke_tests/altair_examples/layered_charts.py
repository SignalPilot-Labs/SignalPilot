...
def _(alt, sp, test_counts):
    ...
    # Layered
    layered_chart = sp.ui.altair_chart(alt.layer(chart, rule))
    layered_chart
...
@app.cell
def _(alt, chart, sp, rule):
    sp.ui.altair_chart(alt.layer(chart, rule), chart_selection="point")
    None
    return
