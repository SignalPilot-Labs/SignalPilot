...
def _(sp):
    sp.md(r"""# Selections with altair maps""")
    return
...
@app.cell(hide_code=True)
def _(sp):
    sp.md("""### Without `sp.ui.altair_chart`""")
    return
...
@app.cell(hide_code=True)
def _(sp):
    sp.md(r"""### With `sp.ui.altair_chart`""")
    return


@app.cell
def _(sp, population_map):
    chart = sp.ui.altair_chart(population_map())
    chart
    return (chart,)
...
@app.cell(hide_code=True)
def _(sp):
    sp.md("""Selecting the bar chart or map should filter the table below""")
    return


@app.cell
def _(chart, sp, us_population):
    sp.hstack([chart.selections, chart.apply_selection(us_population)])
    return
...
@app.cell
def _(sp, world_map):
    world = sp.ui.altair_chart(world_map())
    world
    return (world,)
...
@app.cell
def _(gdf_quakies, gdf_world, sp, world):
    sp.hstack(
        [
