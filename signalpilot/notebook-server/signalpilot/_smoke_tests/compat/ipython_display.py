...
def _(Image):
    ...
    image = Image(url="https://docs.signalpilot.ai/docs/", width=100)
    image
    return
...
@app.cell
def _(IFrame):
    iframe = IFrame("https://docs.signalpilot.ai/docs/", width=800, height=450)
    iframe
    return
...
def _(display_html, display_jpeg, display_png, display_pretty, display_svg):
    ...
    display_png("https://docs.signalpilot.ai/docs/", raw=True)
    display_jpeg("https://docs.signalpilot.ai/docs/", raw=True)
    return
...
def _(
    ...
    display_pdf("https://docs.signalpilot.ai/docs/", raw=True)
    return
