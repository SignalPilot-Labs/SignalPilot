...
# Smoke test for sp ASGI integration with FastAPI.
...
async def homepage():
    return HTMLResponse(
        ...
        <head>
            ...
            <title>sp ASGI Integration Test</title>
            <style>
                body {
        ...
        <body>
            <h1>sp ASGI Integration Test</h1>
            <p>Testing FastAPI + sp ASGI with multiple mount patterns and authentication middleware.</p>
