...
@app.cell
def _(df_with_date_index, sp):
    sp.ui.table(df_with_date_index, label="Pandas with date index")
    return
...
@app.cell
def _(df, sp):
    sp.ui.table(df.to_dict(orient="records"), label="List of dictionaries")
    return
...
def _(data_2, sp, pd):
    ...
    sp.ui.table(table, label="Pyarrow")
    return
...
def _(data_2, sp):
    ...
    sp.ui.table(pl_df, label="Polars")
    return (pl_df,)
