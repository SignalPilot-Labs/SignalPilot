...
@app.cell
def _(sp):
    sp.md(r"""This cell now contains a link to [sp](https://docs.signalpilot.ai/docs/), and suddenly all sort of weird things are happening - line widths change, and there is no lie wrap anymore!""")
    return
