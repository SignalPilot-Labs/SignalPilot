...
@app.cell
def _(sp):
    identity = sp.ui.matrix([[1, 0], [0, 1]], label="Identity")
    identity
    return (identity,)
...
@app.cell
def _(sp, np):
    vecnp = sp.ui.matrix(np.ones(3)); vecnp
    return (vecnp,)
