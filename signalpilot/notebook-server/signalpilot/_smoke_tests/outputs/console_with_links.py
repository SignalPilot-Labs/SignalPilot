...
@app.cell
def _(sys):
    sys.stdout.write("Here is a link in stdout: https://docs.signalpilot.ai/docs/")
    return
...
def _(sys):
    sys.stderr.write(
        "Here is a link in stderr: https://docs.signalpilot.ai/docs/"
    )
    return
...
@app.cell
def _():
    print("Here is a link in a print statement: https://docs.signalpilot.ai/docs/")
    return
