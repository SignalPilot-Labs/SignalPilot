...
def _():
    ...
    **How to test:**
    ...
    Multi-file `sp run` auto-enables process isolation. If all three
...
def _():
    ...
    sp.vstack([
        ...
        sp.image(src=png_bytes, width=64, height=64),
    ])
    return
...
@app.cell
def _():
    # Use sp.ui.table with a small dataset — tables produce .arrow virtual
