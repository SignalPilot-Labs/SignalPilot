...
def _(sp, pd, pl):
    ...
    sp.vstack([sp.md("#### BigInts"), additional_types_pd, additional_types_pl])
    return
...
def _(sp, pd, pl):
    ...
    sp.vstack([sp.md("#### UUIDs"), sp.plain(uuid_df), uuid_df, uuid_polars])
    return
...
def _(sp):
    ...
    sp.ui.dataframe(pandas_with_timestamp)
    return (pd,)
