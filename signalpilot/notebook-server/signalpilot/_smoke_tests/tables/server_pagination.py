...
def _(cars, sp):
    # JSON
    sp.ui.table(cars.to_dict(orient="records"))
    return
...
def _(cars, sp):
    # No pagination
    sp.ui.table(cars[0:20], pagination=False)
    return
...
def _(cars, sp):
    ...
    more_cars = sp.ui.table(_more_cars)
    more_cars
    return (more_cars,)
...
def _(cars):
    ...
    # sp.ui.table(one_mil_cars)
    return


@app.cell
def _(cars, sp):
    sp.ui.dataframe(cars)
    return
