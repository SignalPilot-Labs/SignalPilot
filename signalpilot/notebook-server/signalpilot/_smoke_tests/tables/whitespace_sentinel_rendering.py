...
def _(sp, pl):
    ...
    sp.vstack([sp.md("### Polars"), sp.ui.table(selection=None, data=df)])
    return
...
def _(sp, pd):
    ...
    sp.vstack(
        [
            sp.md("### Pandas classic (object dtype)"),
            sp.ui.table(selection=None, data=pdf_classic),
        ]
    )
    return
...
def _(sp, pd):
    ...
    sp.vstack(
        [
            sp.md("### Pandas nullable (StringDtype / Float64)"),
            sp.ui.table(selection=None, data=pdf_nullable),
        ]
    )
    return
...
def _(sp):
    ...
    sp.vstack(
        [
            sp.md("### Comparison baseline"),
            sp.ui.table(selection=None, data=baseline_rows),
        ]
    )
    return
...
def _(sp):
    ...
    sp.vstack(
        [
            sp.md("### Supported marker chars (space, tab, \\n, \\r)"),
            sp.ui.table(selection=None, data=supported_rows),
        ]
    )
    return
...
def _(sp):
    ...
    sp.vstack(
        [
            sp.md("### Unicode whitespace — detected by \\s, not in marker table"),
            sp.md(
            ...
            sp.ui.table(selection=None, data=unicode_rows),
        ]
    )
    return
...
def _(sp):
    ...
    sp.vstack(
        [
            sp.md("### Popout column (long strings, ≥ 50 chars)"),
            sp.ui.table(selection=None, data=popout_rows),
        ]
    )
    return
