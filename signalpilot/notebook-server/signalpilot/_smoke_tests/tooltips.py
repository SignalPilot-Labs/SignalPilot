...
@app.cell
def _(sp):
    sp.ui.button(label="<span data-tooltip='I said dont press'>Don't press</span>")
    return
...
@app.cell
def _(sp):
    sp.ui.button(tooltip="Click me!", label="Button with tooltip")
    return
...
def _(sp):
    sp.md("""
    ## sp.ui.run_button with tooltip arg
    """)
    return
...
@app.cell
def _(sp):
    sp.ui.run_button(tooltip="Run clicky")
    return
...
def _(sp):
    sp.md("""
    ## sp.ui.button with keyboard shortcut (no explicit tooltip)
...
@app.cell
def _(sp):
    sp.ui.button(label="Save", keyboard_shortcut="Ctrl-S")
    return
...
def _(sp):
    sp.md("""
    ## sp.ui.button with both tooltip and keyboard shortcut
...
def _(sp):
    sp.md("""
    ## sp.ui.form with submit/clear button tooltips
    """)
    return
