...
def _adbc_info_to_dialect(*, info: dict[str | int, Any]) -> str:
    """Infer sp's dialect identifier from ADBC metadata.
    ...
    In sp, ``engine.dialect`` is used primarily for editor/formatter dialect
...
def _schema_field_to_data_type(external_type: str) -> DataType:
    """Map an Arrow-like dtype string to sp DataType."""
