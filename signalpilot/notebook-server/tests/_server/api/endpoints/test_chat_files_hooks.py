...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("mcp__standalone-chat__dashboard_sample_data", True),
        ("mcp__standalone-chat__dashboard_list_published", True),
        ("mcp__standalone-chat__dashboard_load_published", False),
