...
const BOOT_LINES: {
  ...
  {
    text: "loading governance engine...",
    delay: 200,
  ...
  {
    text: "firecracker sandbox: connected",
    delay: 1400,
    color: "text-[var(--color-success)]",
  },
  {
    text: "kvm acceleration: available",
    delay: 1550,
    color: "text-[var(--color-success)]",
  },
  {
    text: "mcp server: listening",
    delay: 1700,
    color: "text-[var(--color-success)]",
  },
  { text: "", delay: 1850, color: "" },
  {
    text: "ready. redirecting to dashboard...",
    delay: 1950,
          ...
          <div className="p-5 font-mono min-h-[320px]">
                ...
                >
                  {line.text === "" ? (
                    ...
                    <>
                      ...
                      <code
                        className={`text-[13px] tracking-wider ${line.color} flex items-center gap-2`}
                      >
                        <span>{line.text}</span>
                        {line.check && (
                          <svg
            ...
            {visibleLines < BOOT_LINES.length && (
              <div className="flex items-center gap-2 mt-1">
                ...
                <span
                  className={`text-[13px] text-[var(--color-success)] ${showCursor ? "opacity-100" : "opacity-0"}`}
                >
                  _
                </span>
              </div>
