...
import { ByokHowItWorks, ByokMigrationStatus } from "./_components/byok-status-sections";
...
export default function BYOKPage() {
  return (
    <AdminGate permission="byok.manage" title="security" subtitle="bring-your-own-key" what="encryption keys">
      <BYOKContent />
    </AdminGate>
  );
}
    ...
    <div className="p-8 max-w-3xl animate-fade-in">
      ...
      {loading ? (
        ...
        <>
          ...
          <ByokMigrationStatus status={status} reverting={reverting} onRevert={handleRevert} />
          <ByokHowItWorks />
        </>
      )}
