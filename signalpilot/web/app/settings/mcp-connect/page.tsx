    ...
    <div className="p-8 max-w-3xl animate-fade-in">
      ...
      {!hasKeys ? null : <section className="mb-8">
        ...
        <div className="border border-[var(--color-border)] bg-[var(--color-bg-card)] rounded-[14px] p-5 space-y-4">
          ...
          {/* Transport metadata */}
          <div className="flex items-center gap-6 text-[11px] text-[var(--color-text-dim)] pt-1">
            <span>
              transport:{" "}
        ...
        {keysError ? (
          <div className="border border-[var(--color-error)]/20 bg-[var(--color-error)]/5 rounded-[14px] p-4 flex items-start gap-3">
            <Info
              ...
              strokeWidth={1.5}
            />
            <p className="text-[12px] text-[var(--color-error)]">{keysError}</p>
          </div>
        ) : firstKey ? (
          <div className="border border-[var(--color-border)] bg-[var(--color-bg-card)] rounded-[14px] p-5">
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  ...
                  <div className="flex items-center gap-2">
                    <code className="text-[13px] text-[var(--color-text-muted)] font-mono">
                      {firstKey.prefix}...
                    </code>
                    <span className="text-[11px] text-[var(--color-text-dim)] truncate max-w-[120px]">
                      ({firstKey.name})
                    </span>
                  </div>
                </div>
              ...
              <Link
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 text-[12px] text-[var(--color-text-dim)] border border-[var(--color-border)] hover:border-[var(--color-border-hover)] hover:text-[var(--color-text)] transition-colors duration-150 flex-shrink-0"
              >
            ...
            {keys.length > 1 && (
              <p className="text-[11px] text-[var(--color-text-dim)] mt-3 pt-3 border-t border-[var(--color-border)]">
          ...
          <div className="border border-[var(--color-border)] bg-[var(--color-bg-card)] rounded-[14px] p-5">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <Link
                  href="/settings/api-keys"
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 text-[12px] text-[var(--color-bg)] bg-[var(--color-text)] rounded-[10px] hover:opacity-90 transition-opacity duration-150 font-medium"
                >
      ...
      {!hasKeys ? null : <section className="mb-8">
          ...
          {CLIENT_TABS.map((tab) => {
            ...
            return (
              <button
                ...
                className={`flex-1 px-4 py-2.5 text-[12px] transition-colors duration-150 border-r last:border-r-0 border-[var(--color-border)] ${
                  isActive
        ...
        <div role="tabpanel" id={`tabpanel-${activeTab}`}>
          ...
          <div className="flex items-center gap-2 mb-2">
            ...
            <code className="text-[12px] text-[var(--color-text-muted)] font-mono">
          ...
          {/* Usage hint */}
          <div className="mt-4 flex items-start gap-2 p-3 border border-[var(--color-border)] bg-[var(--color-bg-card)] rounded-[10px]">
            <Info
              className="w-3.5 h-3.5 text-[var(--color-text-dim)] mt-0.5 flex-shrink-0"
              strokeWidth={1.5}
            />
  ...
  return (
    <div className="p-8 max-w-3xl animate-fade-in">
      ...
      <section className="mb-8">
        ...
        <div className="border border-[var(--color-border)] bg-[var(--color-bg-card)] rounded-[14px] p-5 space-y-4">
          <div>
            <p className="text-[11px] text-[var(--color-text-dim)] uppercase tracking-[0.08em] mb-2">mcp server url</p>
            <div className="flex items-center gap-3">
              <code className="flex-1 px-3 py-2.5 bg-[var(--color-bg)] border border-[var(--color-border)] rounded-[10px] text-[13px] text-[var(--color-success)] font-mono break-all">
                {mcpUrl}
              </code>
          ...
          {firstKey ? (
            <div className="flex items-center justify-between gap-4">
              <div className="flex items-center gap-3 min-w-0">
                ...
                <div className="min-w-0">
                  <p className="text-[11px] text-[var(--color-text-dim)] uppercase tracking-[0.08em] mb-1">active key</p>
                  <div className="flex items-center gap-2">
                    <code className="text-[13px] text-[var(--color-text-muted)] font-mono">{firstKey.prefix}...</code>
                    <span className="text-[11px] text-[var(--color-text-dim)] truncate max-w-[120px]">({firstKey.name})</span>
                  </div>
                </div>
              </div>
              <Link href="/settings/api-keys" className="flex items-center gap-1.5 px-3 py-1.5 text-[12px] text-[var(--color-text-dim)] border border-[var(--color-border)] hover:border-[var(--color-border-hover)] hover:text-[var(--color-text)] transition-colors duration-150 flex-shrink-0">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-[12px] text-[var(--color-text-dim)] leading-relaxed mb-1">
      ...
      <section className="mb-8">
        ...
        <div role="tabpanel">
          <div className="flex items-center gap-2 mb-2">
            ...
            <code className="text-[12px] text-[var(--color-text-muted)] font-mono">{CLIENT_TABS.find((t) => t.id === activeTab)?.filename}</code>
          </div>
