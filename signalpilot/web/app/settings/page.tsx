  ...
  return (
    <div className="p-4 sm:p-8 max-w-3xl mx-auto animate-fade-in">
      ...
      <TerminalBar
        path="settings --edit"
        status={
          <StatusDot status={settings ? "healthy" : "unknown"} size={4} />
        }
      >
          ...
          <div className="p-4 sm:p-6 space-y-4">
            <div className="flex items-start gap-3 p-3 border border-[var(--color-border)] bg-[var(--color-bg)]">
              ...
              <p className="text-[12px] text-[var(--color-text-dim)] tracking-wider leading-relaxed">
                if the gateway has an api key configured, enter it here. stored
                in localStorage, sent as Bearer token.
              </p>
            </div>
            <div>
        ...
        <div className="border border-[var(--color-border)] bg-[var(--color-bg-card)] overflow-hidden">
          <div className="p-4 sm:p-6 space-y-4">
            <p className="text-[12px] text-[var(--color-text-dim)] -mt-1 mb-2 tracking-wider">
              bring your own firecracker — point to any sandbox manager
              endpoint.
            </p>
            <div>
              <label className="block text-[12px] text-[var(--color-text-dim)] mb-1.5 tracking-wider">
          ...
          <div className="p-4 sm:p-6">
              ...
              {[
                {
                  ...
                  desc: "max rows per query",
                  type: "number",
                },
                {
                  label: "default budget (usd)",
                  key: "default_budget_usd",
                  desc: "per-session spending limit",
                  type: "number",
                  step: "0.01",
                },
                {
                ...
                <div key={field.key}>
                  ...
                  <input
                    ...
                    step={field.step}
                    value={
                      settings[field.key as keyof GatewaySettings] as number
                    }
                    onChange={(e) =>
                      setSettings({
                        ...settings,
            ...
            <div className="mt-6 pt-6 border-t border-[var(--color-border)]">
              ...
              <p className="text-[11px] text-[var(--color-text-dim)] mb-3 tracking-wider leading-relaxed">
                tables here are rejected at policy check. queries referencing
                them get a governance error.
              </p>
              ...
              {blockedTables.length > 0 && (
                <div className="flex flex-wrap gap-2">
                  {blockedTables.map((table) => (
                    <span
                      key={table}
                      className="flex items-center gap-1.5 px-2 py-1 border border-[var(--color-error)]/20 text-[12px] tracking-wider group hover:border-[var(--color-error)]/40 transition-colors"
                    >
        ...
        <div className="border border-[var(--color-border)] bg-[var(--color-bg-card)] overflow-hidden">
          <div className="p-4 sm:p-6 space-y-4">
            <div>
              ...
              />
              <p className="text-[11px] text-[var(--color-text-dim)] mt-1 tracking-wider">
                url sandbox vms use to call back to the gateway
              </p>
            </div>
            <div>
              <label className="block text-[12px] text-[var(--color-text-dim)] mb-1.5 tracking-wider">
              ...
              <p className="text-[11px] text-[var(--color-text-dim)] mt-1 tracking-wider">
                when set, all api requests require this key
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-3">
              {[
                ...
                },
                {
                  step: "03",
                  label: "verify",
                  code: "claude mcp list | grep signalpilot",
                },
              ].map((s) => (
                <div key={s.step} className="flex items-start gap-3">
                  <span className="text-[11px] text-[var(--color-text-dim)] tabular-nums tracking-wider mt-2.5 w-5">
                    {s.step}
                  </span>
            ...
            <div className="pt-3 border-t border-[var(--color-border)]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {[
                  ...
                  <div
                    key={tool.name}
                    className="flex items-center gap-2.5 px-3 py-2.5 bg-[var(--color-bg)] border border-[var(--color-border)] hover:border-[var(--color-border-hover)] transition-colors group"
                  >
                    <svg
                      width="10"
                      height="10"
                    ...
                    <div className="min-w-0">
                      <code className="text-[12px] text-[var(--color-text-muted)] tracking-wider block">
                        {tool.name}
                      </code>
