    ...
    <div className="p-8 max-w-3xl">
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-1">
          ...
          <span className="text-[9px] text-[var(--color-text-dim)] tracking-widest uppercase">/ config</span>
        </div>
      ...
      <section className="mb-8">
        <div className="flex items-center gap-2 mb-4">
          <Key className="w-3.5 h-3.5 text-[var(--color-text-dim)]" strokeWidth={1.5} />
          <span className="text-[10px] text-[var(--color-text-dim)] uppercase tracking-widest">browser authentication</span>
        </div>
        <div className="border border-[var(--color-border)] bg-[var(--color-bg-card)] p-6 space-y-4">
          ...
          <div>
            <label className="block text-[10px] text-[var(--color-text-dim)] mb-1 tracking-wider">api key</label>
            ...
            {browserKeySaved && (
              <span className="flex items-center gap-1 mt-2 text-[10px] text-[var(--color-success)] tracking-wider">
      ...
      <section className="mb-8">
        <div className="flex items-center gap-2 mb-4">
          <Server className="w-3.5 h-3.5 text-[var(--color-text-dim)]" strokeWidth={1.5} />
          <span className="text-[10px] text-[var(--color-text-dim)] uppercase tracking-widest">firecracker sandbox (byof)</span>
        </div>
        <div className="border border-[var(--color-border)] bg-[var(--color-bg-card)] p-6 space-y-4">
          ...
          <div>
            <label className="block text-[10px] text-[var(--color-text-dim)] mb-1 tracking-wider">provider</label>
          ...
          <div>
            <label className="block text-[10px] text-[var(--color-text-dim)] mb-1 tracking-wider">sandbox manager url</label>
          ...
          {settings.sandbox_provider === "remote" && (
            <div>
              <label className="block text-[10px] text-[var(--color-text-dim)] mb-1 tracking-wider">sandbox api key</label>
          ...
          <div>
            <label className="block text-[10px] text-[var(--color-text-dim)] mb-1 tracking-wider">max concurrent sandboxes</label>
          ...
          <div className="pt-2">
            <button onClick={handleTestConnection} disabled={testingHealth}
              className="flex items-center gap-2 px-3 py-1.5 text-[10px] text-[var(--color-text-dim)] border border-[var(--color-border)] hover:border-[var(--color-border-hover)] hover:text-[var(--color-text)] transition-colors tracking-wider">
              {testingHealth ? <Loader2 className="w-3 h-3 animate-spin" /> : <Cpu className="w-3 h-3" strokeWidth={1.5} />}
              test sandbox connection
            </button>
            {healthResult && (
              <div className="mt-3 p-3 bg-[var(--color-bg)] border border-[var(--color-border)] text-[10px] font-mono">
      ...
      <section className="mb-8">
        <div className="flex items-center gap-2 mb-4">
          <Shield className="w-3.5 h-3.5 text-[var(--color-success)]" strokeWidth={1.5} />
          <span className="text-[10px] text-[var(--color-text-dim)] uppercase tracking-widest">governance defaults</span>
        </div>
        <div className="border border-[var(--color-border)] bg-[var(--color-bg-card)] p-6">
          ...
          <div className="mt-6 pt-6 border-t border-[var(--color-border)]">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-[10px] text-[var(--color-text-dim)] uppercase tracking-widest">blocked tables</span>
            </div>
            ...
            {blockedTables.length > 0 && (
              <div className="flex flex-wrap gap-2">
                {blockedTables.map((table) => (
                  <span key={table} className="flex items-center gap-1.5 px-2 py-1 border border-[var(--color-error)]/20 text-[10px] tracking-wider">
      ...
      <section className="mb-8">
        <div className="flex items-center gap-2 mb-4">
          <SettingsIcon className="w-3.5 h-3.5 text-[var(--color-text-dim)]" strokeWidth={1.5} />
          <span className="text-[10px] text-[var(--color-text-dim)] uppercase tracking-widest">gateway</span>
        </div>
        <div className="border border-[var(--color-border)] bg-[var(--color-bg-card)] p-6 space-y-4">
          <div>
            <label className="block text-[10px] text-[var(--color-text-dim)] mb-1 tracking-wider">gateway url</label>
          ...
          <div>
            <label className="block text-[10px] text-[var(--color-text-dim)] mb-1 tracking-wider">gateway api key</label>
            <div className="flex items-center gap-2">
              <div className="relative flex-1">
                <input
              ...
              <button
                ...
                className="px-3 py-2 text-[10px] text-[var(--color-text-dim)] border border-[var(--color-border)] hover:border-[var(--color-text-dim)] hover:text-[var(--color-text)] transition-colors whitespace-nowrap tracking-wider"
              >
                generate
              </button>
            </div>
      ...
      <section className="mb-8">
        <div className="flex items-center gap-2 mb-4">
          <Cpu className="w-3.5 h-3.5 text-[var(--color-text-dim)]" strokeWidth={1.5} />
          <span className="text-[10px] text-[var(--color-text-dim)] uppercase tracking-widest">mcp integration</span>
        </div>
        <div className="border border-[var(--color-border)] bg-[var(--color-bg-card)] p-6 space-y-4">
          ...
          <p className="text-[9px] text-[var(--color-text-dim)] tracking-wider">
            exposes governed tools: query_database, execute_code, describe_table, check_budget
          </p>
        </div>
      </section>
      ...
      <div className="flex items-center gap-3">
        ...
        {saved && (
          <span className="flex items-center gap-1 text-[10px] text-[var(--color-success)] tracking-wider">
            <CheckCircle2 className="w-3 h-3" /> saved
          </span>
        )}
      </div>
