...
//   team       = solid square (no cuts)
//   scale      = bottom-right corner cut (8×8 notch)
//   enterprise = both bottom corners cut (8×8 each, symmetric)
// Free tier: no favicon injection (branding is disabled).

const TEAM_SVG =
  '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><rect x="8" y="8" width="16" height="16" fill="#60a5fa"/></svg>';

// bottom-right 8x8 cut: TL(8,8) TR(24,8) right-mid(24,16) notch-corner(16,24) BL(8,24)
const SCALE_SVG =
  '<svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32"><polygon points="8,8 24,8 24,16 16,24 8,24" fill="#a78bfa"/></svg>';
...
const TIER_SVG: Record<BrandTier, string> = {
  team: TEAM_SVG,
  scale: SCALE_SVG,
