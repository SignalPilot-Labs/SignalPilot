...
export const ACCENT_BY_KIND: Record<ToolCardKind, ToolCardAccent> = {
  ...
  knowledge: "knowledge",
  artifact: "artifact",
  dashboard_sample: "data",
  dashboard_screenshot: "artifact",
  dashboard_list: "artifact",
  dashboard_load: "artifact",
  json: "neutral",
  text: "neutral",
  legacy: "neutral",
};
...
export const ICON_BY_KIND: Record<ToolCardKind, LucideIcon> = {
  ...
  knowledge: BookOpen,
  artifact: Upload,
  dashboard_sample: LayoutDashboard,
  dashboard_screenshot: ImageIcon,
  dashboard_list: LayoutList,
  dashboard_load: FolderInput,
  json: Braces,
  text: FileText,
  legacy: FileText,
};
...
export const NOUN_BY_KIND: Record<ToolCardKind, string> = {
  ...
  knowledge: "lookup",
  artifact: "artifact",
  dashboard_sample: "data check",
  dashboard_screenshot: "render",
  dashboard_list: "listing",
