...
export function EmptyState({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center animate-fade-in">
      <div
        className="mb-5 opacity-40 relative"
        style={{ animation: "empty-float 6s ease-in-out infinite" }}
      >
        <Icon className="" />
      ...
      <p className="text-xs text-[var(--color-text-muted)] mb-1.5 tracking-wider">
        {title}
      </p>
      <p className="text-[12px] text-[var(--color-text-dim)] tracking-wider max-w-xs leading-relaxed">
        {description}
      </p>
