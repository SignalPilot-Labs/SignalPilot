...
function PolicyIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      <path
        d="M8 2L13 4V8C13 11 8 14 8 14C8 14 3 11 3 8V4L8 2Z"
        stroke="currentColor"
        strokeWidth="1"
        fill="none"
      />
...
function CostIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
      ...
      />
      <path
        d="M8 5V11M6.5 6.5H9C9.5 6.5 10 7 10 7.5S9.5 8.5 9 8.5H7C6.5 8.5 6 9 6 9.5S6.5 10.5 7 10.5H9.5"
        stroke="currentColor"
        strokeWidth="0.75"
        strokeLinecap="round"
      />
...
const PIPELINE_STEPS: PipelineStep[] = [
  ...
  },
  {
    ...
    detail:
      "Pre-execution cost check, budget validation, expensive query warnings",
    icon: <CostIcon />,
  },
  {
    id: "limit",
...
export function GovernancePipeline() {
  ...
  return (
    <div
      className="border border-[var(--color-border)] bg-[var(--color-bg-card)] overflow-hidden"
            ...
            return (
              <div key={step.id}>
                ...
                >
                  ...
                  <span
                    className={`text-[9px] tabular-nums tracking-wider flex-shrink-0 ${
                      isActive
                        ? "text-[var(--color-success)]"
                        : "text-[var(--color-text-dim)]"
                    }`}
                  ...
                  <span
                    className={`text-[10px] font-medium tracking-wide flex-1 ${
                      isActive
                        ? "text-[var(--color-text)]"
                ...
                {isSelected && (
                  <div className="ml-5 px-3 py-2 border-l-2 border-l-[var(--color-border)] animate-fade-in">
                    <p className="text-[9px] text-[var(--color-text-dim)] tracking-wider mb-1">
                      {step.description}
                    </p>
        ...
        <div className="flex items-center gap-2 mt-3">
          ...
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
            <rect
              ...
              height="14"
              stroke={
                activeStage >= PIPELINE_STEPS.length + 1
                  ? "var(--color-success)"
                  : "var(--color-border-hover)"
              }
              strokeWidth="1"
      ...
      <div className="hidden sm:block px-4 py-5 overflow-hidden">
            ...
            return (
              <div key={step.id} className="flex items-center flex-shrink-0">
                ...
                >
                  {/* Step card */}
                  <div
                    className={`relative px-3 py-2.5 border transition-all duration-300 ${
                      isActive
                  ...
                  >
                    ...
                    {isActive && (
                      <div className="absolute inset-0 pointer-events-none overflow-hidden">
                        <div
                          className="absolute inset-0 border border-[var(--color-success)]/20 animate-pulse"
                    ...
                    <div className="flex items-center gap-2 mb-1.5">
                      ...
                      <span
                        className={`text-[11px] tabular-nums tracking-wider transition-colors duration-300 ${
                          isActive
                            ? "text-[var(--color-success)]"
                            : hoveredStep === step.id
                              ? "text-[var(--color-text-muted)]"
            ...
            <div className="transition-all duration-300">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                <rect
                  ...
                  fillOpacity={
                    activeStage >= PIPELINE_STEPS.length + 1 ? 0.15 : 0
                  }
                />
                <path
        ...
        <div className="flex flex-wrap items-center gap-2 mt-4 pt-3 border-t border-[var(--color-border)]">
          ...
          <span className="text-[11px] text-[var(--color-text-dim)] tracking-wider">
            every query passes through all 6 stages before results reach the
            agent
          </span>
