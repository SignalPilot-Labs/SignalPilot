      ...
      <div className="p-4 sm:p-6 flex items-center justify-center w-full overflow-x-auto">
        ...
        >
          ...
          <g>
            ...
            {["parse", "policy", "cost", "limit", "pii", "audit"].map(
              (stage, i) => (
                <g key={stage}>
                  <rect
                    x={228 + i * 30}
            ...
            <text
              ...
              textAnchor="middle"
              fill={
                governanceActive ? "var(--color-success)" : "var(--color-error)"
              }
              fontSize="10"
              fontFamily="monospace"
              letterSpacing="0.1em"
          ...
          <g>
            <rect
              ...
              strokeWidth="1.5"
              fill="var(--color-bg)"
              strokeDasharray={activeSandboxes > 0 ? "none" : "4 4"}
            />
            <text
              x="550"
              y="180"
