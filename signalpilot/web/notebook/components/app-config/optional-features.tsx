...
export const OptionalFeatures: React.FC = () => {
  const [config] = useResolvedSpConfig();
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden gap-2">
      ...
      <p className="text-sm text-muted-foreground">
        SignalPilot is lightweight, with few dependencies, to maximize compatibility
        with your own environments.
        <br />
        To unlock additional features in the SignalPilot editor, you can install
