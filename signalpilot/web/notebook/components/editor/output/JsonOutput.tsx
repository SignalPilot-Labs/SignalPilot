  ...
  ({
    ...
    switch (format) {
      case "tree":
        return (
          <JsonViewer
            className={cn("sp-json-output", className)}
            rootName={name}
            theme={theme}
            ...
            // See `_key_formatter` in sp-notebook/_output/formatters/structures.py.
...
const REPLACE_PREFIX = "<sp-replace>";
const REPLACE_SUFFIX = "</sp-replace>";
/**
