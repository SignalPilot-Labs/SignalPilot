...
import { KernelStatusIsland } from "../kernel-launch/kernel-status-island";
...
const AddCellButtons: React.FC<{
  ...
  const buttonClass = cn(
    "mb-0 rounded-md sm:px-4 md:px-5 lg:px-8 tracking-wide no-wrap whitespace-nowrap",
    ...
    return (
      <>
        ...
        <Button
          ...
          disabled={!canInteractWithApp}
          onClick={() => {
            maybeAddSpImport({ autoInstantiate: true, createNewCell });
