        ...
        render={({ field }) => (
          <FormItem>
            <div className="flex flex-row items-start space-x-2">
              ...
              <FormControl>
                <Checkbox
                  data-testid="sp-plugin-data-frames-boolean-checkbox"
                  checked={field.value}
      ...
      return (
        <FormField
          ...
          render={({ field }) => (
            <Button
              size="xs"
              data-testid="sp-plugin-data-frames-random-number-button"
              variant="secondary"
              onClick={() => {
        ...
        render={({ field }) => {
          ...
          return (
            <div className="flex flex-col mb-4 gap-1">
              <FormLabel>{label}</FormLabel>
              <NativeSelect
                data-testid="sp-plugin-data-frames-union-select"
                {...field}
              >
                {types.map((type: string) => {
                  return (
  ...
  return (
    <div className="flex flex-col gap-2 min-w-[220px]">
      ...
      <div>
        <Button
          size="xs"
          data-testid="sp-plugin-data-frames-add-array-item"
          variant="text"
    ...
    <FormField
      ...
      render={({ field }) => (
        <FormItem>
          ...
          <FormControl>
            <Select
              data-testid="sp-plugin-data-frames-select"
              value={field.value}
              onValueChange={field.onChange}
            >
