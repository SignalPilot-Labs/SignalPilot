...
const StorageEntryRow: React.FC<{
  ...
  return (
    <>
      <CommandItem
        className={cn(
          "text-xs flex items-center gap-1.5 cursor-pointer rounded-md group h-6.5",
          isDir && "font-medium",
        )}
        style={indentStyle(depth)}
  ...
  return (
    <>
      <CommandItem
        ...
        className="flex flex-row font-semibold h-7 text-xs gap-1.5 bg-(--slate-2) text-muted-foreground rounded-md"
      >
...
export const StorageInspector: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <Command
        className={cn(
          "border-b bg-background rounded-md h-full pb-10 overflow-auto outline-hidden scrollbar-thin",
        ...
        <div className="flex items-center w-full border-b">
          ...
          <AddConnectionDialog defaultTab="storage">
            <Button
              variant="ghost"
              size="sm"
              className="px-2 border-0 border-l border-muted-background rounded-md focus-visible:ring-0 focus-visible:ring-offset-0"
            >
