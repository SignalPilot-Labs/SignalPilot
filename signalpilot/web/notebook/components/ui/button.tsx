...
const buttonVariants = cva(
  cn(
    ...
    "inline-flex items-center justify-center rounded-md text-xs font-medium tracking-wider focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-2 ring-offset-background font-mono",
  ),
  {
    variants: {
      variant: {
