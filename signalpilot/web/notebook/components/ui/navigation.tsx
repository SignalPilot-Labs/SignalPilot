...
const navigationMenuListStyle = cva("group flex list-none gap-1", {
  variants: {
    orientation: {
...
const NavigationMenuList = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof NavigationMenuPrimitive.List> &
    VariantProps<typeof navigationMenuListStyle>
>(({ className, orientation, ...props }, ref) => (
  <NavigationMenuPrimitive.List
    ref={ref}
    className={cn(navigationMenuListStyle({ orientation }), className)}
    {...props}
  />
));
