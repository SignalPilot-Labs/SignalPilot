import type { components, paths } from "@/packages/sp-api";
...
export type SpConfig = schemas["SpConfig"];
export type SpFile = schemas["SpFile"];
...
export interface EditRequests {
  ...
  // Homepage requests
  openTutorial: (request: OpenTutorialRequest) => Promise<SpFile>;
