...
export interface paths {
  ...
  "/api/dbt/artifact": {
    ...
    post: {
      ...
      requestBody?: {
        content: {
          "application/json": components["schemas"]["DbtArtifactRequest"];
        };
      };
      responses: {
    ...
    post: {
      ...
      responses: {
        ...
        200: {
          ...
          content: {
            "application/json": components["schemas"]["SpFile"];
          };
        };
      };
    };
...
export interface components {
  schemas: {
    ...
    CellOutput: {
      ...
      data:
        ...
        | (
            ...
            | components["schemas"]["SpAncestorStoppedError"]
            | components["schemas"]["SpAncestorPreventedError"]
            | components["schemas"]["SpExceptionRaisedError"]
            | components["schemas"]["SpStrictExecutionError"]
            | components["schemas"]["SpInterruptionError"]
            | components["schemas"]["SpSyntaxError"]
            | components["schemas"]["SpInternalError"]
            | components["schemas"]["SpSQLError"]
    ...
    /** RecentFilesResponse */
    RecentFilesResponse: {
      files: components["schemas"]["SpFile"][];
    };
    /**
    ...
    /**
     * SpConfig
     * @description Configuration for the sp editor
     */
    SpConfig: {
     ...
     */
    UpdateUserConfigCommand: {
      config: components["schemas"]["SpConfig"];
      /** @enum {unknown} */
