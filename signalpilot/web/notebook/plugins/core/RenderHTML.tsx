...
// Wrap elements with data-sp-doc attribute in a DocHoverTarget
const wrapDocHoverTargets: TransformFn = (
  reactNode: ReactNode,
  domNode: DOMNode,
): JSX.Element | undefined => {
  if (domNode instanceof Element && domNode.attribs?.["data-sp-doc"]) {
    const qualifiedName = domNode.attribs["data-sp-doc"];
    return (
...
//
// SP custom elements (sp-button, etc.) are skipped — they handle
