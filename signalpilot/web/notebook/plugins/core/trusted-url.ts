...
/**
 * Whether a URL can be trusted to point at a sp-served virtual file.
 *
 ...
 * maliciously crafted `<sp-*>` element embedded in markdown load
 * attacker-controlled JavaScript at same origin, since the HTML sanitizer
 * lets arbitrary sp custom elements and attributes through.
 *
