// Turbopack compat: ?inline stripped — raw-loader is configured in next.config.ts for this file
import glideCss from "@glideapps/glide-data-grid/dist/index.css";
...
export const DataEditorPlugin = createPlugin<Edits>("sp-data-editor", {
  cssStyles: [glideCss],
})
  .withData(
    z.object({
