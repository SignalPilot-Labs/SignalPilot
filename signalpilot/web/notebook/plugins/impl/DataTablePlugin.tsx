...
export const DataTablePlugin = createPlugin<S>("sp-table")
  .withData(
    z.object({
  ...
  <T extends {}>(
    ...
    const { data, error, isPending, isFetching } = useAsyncData<{
      ...
      if (canShowInitialPage) {
        ...
        // see https://github.com/SignalPilot-Labs/SignalPilot/issues/2756
  ...
  const handleCellSelectionChange: OnChangeFn<CellSelectionState> = useEvent(
    (updater) => {
      if (selection === "single-cell") {
        ...
        // This maps to the _value in sp/_plugins/ui/_impl/table.py
