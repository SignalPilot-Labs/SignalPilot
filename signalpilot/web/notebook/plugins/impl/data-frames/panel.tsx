        ...
        >
            ...
            {(selectedTransform === undefined || !selectedTransformSchema) && (
              <div className="flex flex-col items-center justify-center grow gap-3">
                ...
                <AddTransformDropdown onAdd={handleAddTransform}>
                  <Button
                    data-testid="sp-plugin-data-frames-add-transform"
                    variant="text"
                    size="xs"
                  >
          ...
          {lazy && (
            <div className="absolute bottom-0 right-0 border-l border-t rounded-tl-sm flex flex-row items-center gap-1 p-1.5 pr-1">
              <Button
                data-testid="sp-plugin-data-frames-apply"
      ...
      <div className="flex flex-row shrink-0">
        <AddTransformDropdown onAdd={onAdd}>
          <Button
            data-testid="sp-plugin-data-frames-add-transform"
            variant="text"
            className="w-full rounded-md m-0 hover:text-accent-foreground"
            size="xs"
          >
        ...
        <DropdownMenuGroup>
          ...
          <DropdownMenuItem
            ...
            onSelect={(evt) => {
              evt.stopPropagation();
              window.open(
                "https://github.com/SignalPilot-Labs/SignalPilot/issues/new?title=New%20dataframe%20transform:&labels=enhancement&template=feature_request.yaml",
                "_blank",
              );
            }}
          >
