...
import { SpIncomingMessageEvent } from "@/core/dom/events";
import {
...
export default function PanelComponent({ data, functions, host }: Props): JSX.Element {
