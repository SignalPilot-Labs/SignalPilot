...
export function DashboardChartCard({ chart }: DashboardChartCardProps) {
  const cached = chart.cachedData;

  return (
    <div className="bg-[var(--color-sidebar)] border border-[var(--color-border)] p-4 flex flex-col h-full">
      <div className="flex items-baseline justify-between mb-3">
        <h3 className="text-[13px] font-bold tracking-wider uppercase text-[var(--color-text)] truncate">
          {chart.title}
        </h3>
