...
export function NewDashboardModal({ open, onClose }: NewDashboardModalProps) {
  ...
  return (
    ...
    >
      <div className="bg-[var(--color-sidebar)] border border-[var(--color-border)] w-full max-w-md p-6">
        <h2 className="text-sm font-bold tracking-wider uppercase text-[var(--color-text)] mb-4">
          new dashboard
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label
              ...
              className="block text-[12px] uppercase tracking-wider text-[var(--color-text-dim)] mb-1"
            >
              name
            </label>
            <input
          ...
          <div className="flex gap-2 justify-end pt-2">
            <button
              ...
              onClick={onClose}
              disabled={isPending}
              className="px-4 py-2 text-[12px] uppercase tracking-wider text-[var(--color-text-muted)] border border-[var(--color-border)] hover:border-[var(--color-border-hover)] transition-colors"
            >
              cancel
            </button>
            <button
              ...
              className="px-4 py-2 text-[12px] uppercase tracking-wider bg-[var(--color-text)] text-[var(--color-bg)] hover:opacity-90 transition-opacity disabled:opacity-50"
            >
